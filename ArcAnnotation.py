"""
AngleAnnotation class given by matplotlib.
I've "modified" it to work with my vectors.
...
class AngleAnnotation(Arc):
    ...
    def __init__(self, xy, p1, p2, size=75, unit="points", ax=None,
        ...
        Args:
            xy, p1, p2 (tuple or array of two floats): Center position and two points.
            Angle annotation is drawn between the two vectors connecting *p1* and *p2* with *xy*, respectively.
            ...
            textposition (str): Whether to show the text in- or outside the arc.
                "edge" can be used for custom positions anchored at the arc's edge.
    ...
    def get_theta(self, vec):
        """return angle of vec in degrees"""
        vec_in_pixels = self.ax.transData.transform(vec) - self._center

        return np.rad2deg(np.arctan2(vec_in_pixels[0][1], vec_in_pixels[0][0]))

    def get_theta1(self):
        """return angle of vec1 in degrees"""
        return self.get_theta(self.vec1)

    def get_theta2(self):
        """return angle of vec2 in degrees"""
        return self.get_theta(self.vec2)

    def set_theta(self, angle):
        """set angle of vec1 and vec2 in degrees"""
        pass
    ...
    def update_text(self):
        """
        Update the text position according to the textposition attribute.
        Returns:
            self
        """
        c = self._center
